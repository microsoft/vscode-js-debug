...
export namespace Dap {
  export interface DapProxyApi {
     ...
     */
    on(request: 'initialize', handler: (params: InitializeParams) => Promise<InitializeResult>): void;
     ...
     */
    on(request: 'configurationDone', handler: (params: ConfigurationDoneParams) => Promise<ConfigurationDoneResult>): void;
     ...
     */
    on(request: 'launch', handler: (params: LaunchParams) => Promise<LaunchResult>): void;
     ...
     */
    on(request: 'attach', handler: (params: AttachParams) => Promise<AttachResult>): void;
     ...
     */
    on(request: 'restart', handler: (params: RestartParams) => Promise<RestartResult>): void;
     ...
     */
    on(request: 'disconnect', handler: (params: DisconnectParams) => Promise<DisconnectResult>): void;

    /**
     * The 'terminate' request is sent from the client to the debug adapter in order to give the debuggee a chance for terminating itself.
     */
    on(request: 'terminate', handler: (params: TerminateParams) => Promise<TerminateResult>): void;
     ...
     */
    on(request: 'setBreakpoints', handler: (params: SetBreakpointsParams) => Promise<SetBreakpointsResult>): void;
     ...
     */
    on(request: 'setFunctionBreakpoints', handler: (params: SetFunctionBreakpointsParams) => Promise<SetFunctionBreakpointsResult>): void;
     ...
     */
    on(request: 'setExceptionBreakpoints', handler: (params: SetExceptionBreakpointsParams) => Promise<SetExceptionBreakpointsResult>): void;

    /**
     * Obtains information on a possible data breakpoint that could be set on an expression or variable.
     */
    on(request: 'dataBreakpointInfo', handler: (params: DataBreakpointInfoParams) => Promise<DataBreakpointInfoResult>): void;
     ...
     */
    on(request: 'setDataBreakpoints', handler: (params: SetDataBreakpointsParams) => Promise<SetDataBreakpointsResult>): void;

    /**
     * The request starts the debuggee to run again.
     */
    on(request: 'continue', handler: (params: ContinueParams) => Promise<ContinueResult>): void;

    /**
     * The request starts the debuggee to run again for one step.
     * The debug adapter first sends the response and then a 'stopped' event (with reason 'step') after the step has completed.
     */
    on(request: 'next', handler: (params: NextParams) => Promise<NextResult>): void;
     ...
     */
    on(request: 'stepIn', handler: (params: StepInParams) => Promise<StepInResult>): void;

    /**
     * The request starts the debuggee to run again for one step.
     * The debug adapter first sends the response and then a 'stopped' event (with reason 'step') after the step has completed.
     */
    on(request: 'stepOut', handler: (params: StepOutParams) => Promise<StepOutResult>): void;
     ...
     */
    on(request: 'stepBack', handler: (params: StepBackParams) => Promise<StepBackResult>): void;
     ...
     */
    on(request: 'reverseContinue', handler: (params: ReverseContinueParams) => Promise<ReverseContinueResult>): void;

    /**
     * The request restarts execution of the specified stackframe.
     * The debug adapter first sends the response and then a 'stopped' event (with reason 'restart') after the restart has completed.
     */
    on(request: 'restartFrame', handler: (params: RestartFrameParams) => Promise<RestartFrameResult>): void;
     ...
     */
    on(request: 'goto', handler: (params: GotoParams) => Promise<GotoResult>): void;

    /**
     * The request suspenses the debuggee.
     * The debug adapter first sends the response and then a 'stopped' event (with reason 'pause') after the thread has been paused successfully.
     */
    on(request: 'pause', handler: (params: PauseParams) => Promise<PauseResult>): void;

    /**
     * The request returns a stacktrace from the current execution state.
     */
    on(request: 'stackTrace', handler: (params: StackTraceParams) => Promise<StackTraceResult>): void;

    /**
     * The request returns the variable scopes for a given stackframe ID.
     */
    on(request: 'scopes', handler: (params: ScopesParams) => Promise<ScopesResult>): void;

    /**
     * Retrieves all child variables for the given variable reference.
     * An optional filter can be used to limit the fetched children to either named or indexed children.
     */
    on(request: 'variables', handler: (params: VariablesParams) => Promise<VariablesResult>): void;

    /**
     * Set the variable with the given name in the variable container to a new value.
     */
    on(request: 'setVariable', handler: (params: SetVariableParams) => Promise<SetVariableResult>): void;

    /**
     * The request retrieves the source code for a given source reference.
     */
    on(request: 'source', handler: (params: SourceParams) => Promise<SourceResult>): void;

    /**
     * The request retrieves a list of all threads.
     */
    on(request: 'threads', handler: (params: ThreadsParams) => Promise<ThreadsResult>): void;

    /**
     * The request terminates the threads with the given ids.
     */
    on(request: 'terminateThreads', handler: (params: TerminateThreadsParams) => Promise<TerminateThreadsResult>): void;
     ...
     */
    on(request: 'modules', handler: (params: ModulesParams) => Promise<ModulesResult>): void;

    /**
     * Retrieves the set of all sources currently loaded by the debugged process.
     */
    on(request: 'loadedSources', handler: (params: LoadedSourcesParams) => Promise<LoadedSourcesResult>): void;

    /**
     * Evaluates the given expression in the context of the top most stack frame.
     * The expression has access to any variables and arguments that are in scope.
     */
    on(request: 'evaluate', handler: (params: EvaluateParams) => Promise<EvaluateResult>): void;

    /**
     * Evaluates the given 'value' expression and assigns it to the 'expression' which must be a modifiable l-value.
     * The expressions have access to any variables and arguments that are in scope of the specified frame.
     */
    on(request: 'setExpression', handler: (params: SetExpressionParams) => Promise<SetExpressionResult>): void;
     ...
     */
    on(request: 'stepInTargets', handler: (params: StepInTargetsParams) => Promise<StepInTargetsResult>): void;
     ...
     */
    on(request: 'gotoTargets', handler: (params: GotoTargetsParams) => Promise<GotoTargetsResult>): void;

    /**
     * Returns a list of possible completions for a given caret position and text.
     * The CompletionsRequest may only be called if the 'supportsCompletionsRequest' capability exists and is true.
     */
    on(request: 'completions', handler: (params: CompletionsParams) => Promise<CompletionsResult>): void;

    /**
     * Retrieves the details of the exception that caused this event to be raised.
     */
    on(request: 'exceptionInfo', handler: (params: ExceptionInfoParams) => Promise<ExceptionInfoResult>): void;

    /**
     * Reads bytes from memory at the provided location.
     */
    on(request: 'readMemory', handler: (params: ReadMemoryParams) => Promise<ReadMemoryResult>): void;

    /**
     * Disassembles code stored at the provided location.
     */
    on(request: 'disassemble', handler: (params: DisassembleParams) => Promise<DisassembleResult>): void;
  }
