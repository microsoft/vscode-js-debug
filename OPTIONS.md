...
<h5>Default value:</h4><pre><code>null</pre></code><h4>hostHeader</h4><p>Host header to use when connecting to the debug target.</p>
<h5>Default value:</h4><pre><code>"localhost"</pre></code><h4>localRoot</h4><p>Path to the local directory containing the program.</p>
