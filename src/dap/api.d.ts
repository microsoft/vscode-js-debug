...
/****************************************************************
 * Auto-generated by generateDap.js, do not edit manually. *
 ****************************************************************/
 ...
 */
on(request: 'startDebugging', handler: (params: StartDebuggingParams) => Promise<StartDebuggingResult | Error>): () => void;
/**
 * This request is sent from the debug adapter to the client to start a new debug session of the same type as the caller.
 * This request should only be sent if the corresponding client capability `supportsStartDebuggingRequest` is true.
 * A client implementation of `startDebugging` should start a new debug session (of the same type as the caller) in the same way that the caller's session was started. If the client supports hierarchical debug sessions, the newly created session can be treated as a child of the caller session.
 ...
 */
on(request: 'setInstructionBreakpoints', handler: (params: SetInstructionBreakpointsParams) => Promise<SetInstructionBreakpointsResult | Error>): () => void;
/**
 * Replaces all existing instruction breakpoints. Typically, instruction breakpoints would be set from a disassembly window. 
 * To clear all instruction breakpoints, specify an empty array.
 * When an instruction breakpoint is hit, a `stopped` event (with reason `instruction breakpoint`) is generated.
 * Clients should only call this request if the corresponding capability `supportsInstructionBreakpoints` is true.
 */
setInstructionBreakpointsRequest(params: SetInstructionBreakpointsParams): Promise<SetInstructionBreakpointsResult>;
 ...
 */
on(request: 'writeMemory', handler: (params: WriteMemoryParams) => Promise<WriteMemoryResult | Error>): () => void;
/**
 * Writes bytes to memory at the provided location.
 * Clients should only call this request if the corresponding capability `supportsWriteMemoryRequest` is true.
 */
 ...
 */
on(request: 'locations', handler: (params: LocationsParams) => Promise<LocationsResult | Error>): () => void;
/**
 * Looks up information about a location reference previously returned by the debug adapter.
 */
 ...
 */
on(request: 'setCustomBreakpoints', handler: (params: SetCustomBreakpointsParams) => Promise<SetCustomBreakpointsResult | Error>): () => void;
/**
 * Sets the enabled custom breakpoints.
 */
setCustomBreakpointsRequest(params: SetCustomBreakpointsParams): Promise<SetCustomBreakpointsResult>;

/**
 * Enables or disables focused page emulation.
 */
on(request: 'setFocusEmulationEnabled', handler: (params: SetFocusEmulationEnabledParams) => Promise<SetFocusEmulationEnabledResult | Error>): () => void;
/**
 * Enables or disables focused page emulation.
 */
setFocusEmulationEnabledRequest(params: SetFocusEmulationEnabledParams): Promise<SetFocusEmulationEnabledResult>;
 ...
 */
on(request: 'startProfile', handler: (params: StartProfileParams) => Promise<StartProfileResult | Error>): () => void;
/**
 * Starts taking a profile of the target.
 */
 ...
 */
on(request: 'stopProfile', handler: (params: StopProfileParams) => Promise<StopProfileResult | Error>): () => void;
/**
 * Stops a running profile.
 */
 ...
 */
on(request: 'launchVSCode', handler: (params: LaunchVSCodeParams) => Promise<LaunchVSCodeResult | Error>): () => void;
/**
 * Launches a VS Code extension host in debug mode.
 */
 ...
 * Launches a VS Code extension host in debug mode.
 */
on(request: 'launchUnelevated', handler: (params: LaunchUnelevatedParams) => Promise<LaunchUnelevatedResult | Error>): () => void;
/**
 * Launches a VS Code extension host in debug mode.
 */
 ...
 */
on(request: 'remoteFileExists', handler: (params: RemoteFileExistsParams) => Promise<RemoteFileExistsResult | Error>): () => void;
/**
 * Check if file exists on remote file system, used in VS.
 */
 ...
 */
on(request: 'revealPage', handler: (params: RevealPageParams) => Promise<RevealPageResult | Error>): () => void;
/**
 * Focuses the browser page or tab associated with the session.
 */
 ...
 */
on(request: 'startSelfProfile', handler: (params: StartSelfProfileParams) => Promise<StartSelfProfileResult | Error>): () => void;
/**
 * Starts profiling the extension itself. Used by VS.
 */
 ...
 */
on(request: 'stopSelfProfile', handler: (params: StopSelfProfileParams) => Promise<StopSelfProfileResult | Error>): () => void;
/**
 * Stops profiling the extension itself. Used by VS.
 */
 ...
 */
on(request: 'getPerformance', handler: (params: GetPerformanceParams) => Promise<GetPerformanceResult | Error>): () => void;
/**
 * Requests that we get performance information from the runtime.
 */
 ...
 */
on(request: 'disableSourcemap', handler: (params: DisableSourcemapParams) => Promise<DisableSourcemapResult | Error>): () => void;
/**
 * Disables the sourcemapped source and refreshes the stacktrace if paused.
 */
 ...
 */
on(request: 'createDiagnostics', handler: (params: CreateDiagnosticsParams) => Promise<CreateDiagnosticsResult | Error>): () => void;
/**
 * Generates diagnostic information for the debug session.
 */
 ...
 */
on(request: 'saveDiagnosticLogs', handler: (params: SaveDiagnosticLogsParams) => Promise<SaveDiagnosticLogsResult | Error>): () => void;
/**
 * Saves recent diagnostic logs for the debug session.
 */
 ...
 */
on(request: 'requestCDPProxy', handler: (params: RequestCDPProxyParams) => Promise<RequestCDPProxyResult | Error>): () => void;
/**
 * Request WebSocket connection information on a proxy for this debug sessions CDP connection.
 */
 ...
 */
on(request: 'setExcludedCallers', handler: (params: SetExcludedCallersParams) => Promise<SetExcludedCallersResult | Error>): () => void;
/**
 * Adds an excluded caller/target pair.
 */
 ...
 */
on(request: 'setSourceMapStepping', handler: (params: SetSourceMapSteppingParams) => Promise<SetSourceMapSteppingResult | Error>): () => void;
/**
 * Configures whether source map stepping is enabled.
 */
setSourceMapSteppingRequest(params: SetSourceMapSteppingParams): Promise<SetSourceMapSteppingResult>;

/**
 * Sets debugger properties.
 */
on(request: 'setDebuggerProperty', handler: (params: SetDebuggerPropertyParams) => Promise<SetDebuggerPropertyResult | Error>): () => void;
/**
 * Sets debugger properties.
 */
setDebuggerPropertyRequest(params: SetDebuggerPropertyParams): Promise<SetDebuggerPropertyResult>;

/**
 * The event indicates that one or more capabilities have changed.
 */
on(request: 'capabilitiesExtended', handler: (params: CapabilitiesExtendedParams) => Promise<CapabilitiesExtendedResult | Error>): () => void;
/**
 * The event indicates that one or more capabilities have changed.
 */
capabilitiesExtendedRequest(params: CapabilitiesExtendedParams): Promise<CapabilitiesExtendedResult>;

/**
 * Used by evaluate and variables.
 */
on(request: 'evaluationOptions', handler: (params: EvaluationOptionsParams) => Promise<EvaluationOptionsResult | Error>): () => void;
/**
 * Used by evaluate and variables.
 */
 ...
 */
on(request: 'setSymbolOptions', handler: (params: SetSymbolOptionsParams) => Promise<SetSymbolOptionsResult | Error>): () => void;
/**
 * Sets options for locating symbols.
 */
 ...
 */
on(request: 'networkCall', handler: (params: NetworkCallParams) => Promise<NetworkCallResult | Error>): () => void;
/**
 * Makes a network call. There is little abstraction here because UI interacts literally with CDP at the moment.
 */
 ...
 */
on(request: 'enableNetworking', handler: (params: EnableNetworkingParams) => Promise<EnableNetworkingResult | Error>): () => void;
/**
 * Attempts to enable networking on the target.
 */
 ...
 */
on(request: 'getPreferredUILocation', handler: (params: GetPreferredUILocationParams) => Promise<GetPreferredUILocationResult | Error>): () => void;
/**
 * Resolves a compiled location into a preferred source location. May be used by other VS Code extensions.
 */
getPreferredUILocationRequest(params: GetPreferredUILocationParams): Promise<GetPreferredUILocationResult>;
}
...
once(request: 'progressStart', filter?: (event: ProgressStartEventParams) => boolean): Promise<ProgressStartEventParams>;
...
once(request: 'progressUpdate', filter?: (event: ProgressUpdateEventParams) => boolean): Promise<ProgressUpdateEventParams>;
...
once(request: 'progressEnd', filter?: (event: ProgressEndEventParams) => boolean): Promise<ProgressEndEventParams>;
...
once(request: 'invalidated', filter?: (event: InvalidatedEventParams) => boolean): Promise<InvalidatedEventParams>;
...
once(request: 'memory', filter?: (event: MemoryEventParams) => boolean): Promise<MemoryEventParams>;
 ...
 * Clients should only call this request if the corresponding capability `supportsInstructionBreakpoints` is true.
 */
setInstructionBreakpoints(params: SetInstructionBreakpointsParams): Promise<SetInstructionBreakpointsResult>;
...
once(request: 'longPrediction', filter?: (event: LongPredictionEventParams) => boolean): Promise<LongPredictionEventParams>;

/**
 * Request to launch a browser in the companion extension within the UI.
 */
on(request: 'launchBrowserInCompanion', handler: (params: LaunchBrowserInCompanionEventParams) => void): void;
off(request: 'launchBrowserInCompanion', handler: (params: LaunchBrowserInCompanionEventParams) => void): void;
once(request: 'launchBrowserInCompanion', filter?: (event: LaunchBrowserInCompanionEventParams) => boolean): Promise<LaunchBrowserInCompanionEventParams>;

/**
 * Kills a launched browser companion.
 */
on(request: 'killCompanionBrowser', handler: (params: KillCompanionBrowserEventParams) => void): void;
off(request: 'killCompanionBrowser', handler: (params: KillCompanionBrowserEventParams) => void): void;
once(request: 'killCompanionBrowser', filter?: (event: KillCompanionBrowserEventParams) => boolean): Promise<KillCompanionBrowserEventParams>;
...
once(request: 'profileStarted', filter?: (event: ProfileStartedEventParams) => boolean): Promise<ProfileStartedEventParams>;

/**
 * Fired when a profiling state changes.
 */
on(request: 'profilerStateUpdate', handler: (params: ProfilerStateUpdateEventParams) => void): void;
off(request: 'profilerStateUpdate', handler: (params: ProfilerStateUpdateEventParams) => void): void;
once(request: 'profilerStateUpdate', filter?: (event: ProfilerStateUpdateEventParams) => boolean): Promise<ProfilerStateUpdateEventParams>;
 ...
 * Fired when requesting a missing source from a sourcemap. UI will offer to disable the sourcemap.
 */
on(request: 'suggestDisableSourcemap', handler: (params: SuggestDisableSourcemapEventParams) => void): void;
off(request: 'suggestDisableSourcemap', handler: (params: SuggestDisableSourcemapEventParams) => void): void;
once(request: 'suggestDisableSourcemap', filter?: (event: SuggestDisableSourcemapEventParams) => boolean): Promise<SuggestDisableSourcemapEventParams>;
 ...
 * Shows a prompt to the user suggesting they use the diagnostic tool if breakpoints don't bind.
 */
on(request: 'suggestDiagnosticTool', handler: (params: SuggestDiagnosticToolEventParams) => void): void;
off(request: 'suggestDiagnosticTool', handler: (params: SuggestDiagnosticToolEventParams) => void): void;
once(request: 'suggestDiagnosticTool', filter?: (event: SuggestDiagnosticToolEventParams) => boolean): Promise<SuggestDiagnosticToolEventParams>;

/**
 * Opens the diagnostic tool if breakpoints don't bind.
 */
on(request: 'openDiagnosticTool', handler: (params: OpenDiagnosticToolEventParams) => void): void;
off(request: 'openDiagnosticTool', handler: (params: OpenDiagnosticToolEventParams) => void): void;
once(request: 'openDiagnosticTool', filter?: (event: OpenDiagnosticToolEventParams) => boolean): Promise<OpenDiagnosticToolEventParams>;
...
once(request: 'networkEvent', filter?: (event: NetworkEventEventParams) => boolean): Promise<NetworkEventEventParams>;
 ...
 * Resolves a compiled location into a preferred source location. May be used by other VS Code extensions.
 */
getPreferredUILocation(params: GetPreferredUILocationParams): Promise<GetPreferredUILocationResult>;
}
...
/**
 * Whether to emulate a focused page. Defaults to toggling the current state.
 */
enabled?: boolean;
}
...
/**
 * Whether focused page emulation is enabled after the request.
 */
enabled: boolean;
}
 ...
 */
export type BreakpointModeApplicability = string;
