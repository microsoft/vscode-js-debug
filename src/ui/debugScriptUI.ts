...
export function registerDebugScriptActions(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    vscode.commands.registerCommand('pwa.debugTask', async e => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(Contributions.PickLoadedScriptCommand, async e => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('pwa.createDebuggerTerminal', async e => {
