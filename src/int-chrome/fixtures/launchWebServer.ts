...
export class LaunchWebServer implements IFixture {
    ...
    public get launchConfig(): IChromeLaunchConfiguration {
        return Object.assign({}, this.testSpec.props.launchConfig, { url: this.url.toString() }) as IChromeLaunchConfiguration; // TODO@rob
    }
...
export class ProvideStaticUrl implements IFixture {
    ...
    public get launchConfig(): IChromeLaunchConfiguration {
        return {...this.testSpec.props.launchConfig, url: this.url.href } as IChromeLaunchConfiguration; // TODO@rob
    }
    cleanUp() {}
}