...
testUsing.skip('Hit breakpoint on JavaScript when source map is invalid', context => LaunchProject.launch(context, TestProjectSpec.fromTestPath('featuresTests/invalidSourceMap')),
    async (launchProject) => {
