...
const SINGLE_INLINE_TEST_SPEC = TestProjectSpec.fromTestPath('inline_scripts', '', pathToFileURL(path.join(testSetup.DATA_ROOT, 'inline_scripts/single.html')));
const MULTIPLE_INLINE_TEST_SPEC = TestProjectSpec.fromTestPath('inline_scripts', '', pathToFileURL(path.join(testSetup.DATA_ROOT, 'inline_scripts/multiple.html')));
