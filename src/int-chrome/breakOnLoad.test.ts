...
function runCommonTests(breakOnLoadStrategy: BreakOnLoadStrategy) {
    ...
    setup(function () {
        return testSetup.setup(this, { breakOnLoadStrategy: breakOnLoadStrategy })
            .then(_dc => dc = _dc);
    });
...
suite.skip('BreakOnLoad', () => {
    ...
    suite('Instrument Webpack Project', () => {
        let dc: ExtendedDebugClient;
        setup(function () {
            return testSetup.setup(this, { breakOnLoadStrategy: 'instrument' })
                .then(_dc => dc = _dc);
        });
    ...
    suite('BreakOnLoad Disabled (strategy: off)', () => {
        let dc: ExtendedDebugClient;
        setup(function () {
            return testSetup.setup(this, { breakOnLoadStrategy: 'off' })
                .then(_dc => dc = _dc);
        });
